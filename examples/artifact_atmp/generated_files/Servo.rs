...
// Endpoint for role C
type Endpoint_0_ForC = MeshedChannels<Message_0_v_0_FromCToL, Message_0_v_0_FromCToS, Ordering_0_v_0_ForC, NameC>;

// Endpoint for role L
type Endpoint_0_ForL = MeshedChannels<Message_0_v_0_FromLToC, Message_0_v_0_FromLToS, Ordering_0_v_0_ForL, NameL>;

// Endpoint for role S
type Endpoint_0_ForS = MeshedChannels<Message_0_v_0_FromSToC, Message_0_v_0_FromSToL, Ordering_0_v_0_ForS, NameS>;
...
fn endpoint_l_0_v_0(s: Endpoint_0_ForL, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {
	all_clocks.insert('a', Instant::now());
...
fn main() {
	let (thread_c, thread_l, thread_s, ) = fork_mpst(endpoint_c_0_v_0, endpoint_l_0_v_0, endpoint_s_0_v_0, );
