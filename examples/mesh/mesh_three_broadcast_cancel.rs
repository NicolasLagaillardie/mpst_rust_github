...
enum Branching0fromCtoA {
    More(MeshedChannelsFour<End, RS, Recv<(), Send<(), RecursAtoC>>, R2C<R2B<RoleC<RoleEnd>>>, NameA>),
...
enum Branching0fromCtoB {
    More(MeshedChannelsFour<End, SR, Recv<(), Send<(), RecursBtoC>>, R2C<R2A<RoleC<RoleEnd>>>, NameB>),
