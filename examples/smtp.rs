...
enum Branching0fromCtoS {
    Continue(SessionMpstTwo<Recv<(), Choose1fromStoC>, RoleC<RoleBroadcast>, NameS>),
...
enum Branching1fromStoC {
    Continue(SessionMpstTwo<Recv<(), Choose2fromCtoS>, RoleS<RoleS<RoleEnd>>, NameC>),
    Loop(SessionMpstTwo<Recv<(), Offer2fromCtoS>, RoleS<RoleS<RoleEnd>>, NameC>),
}
type Offer1fromStoC = <Choose1fromStoC as Session>::Dual;
type EndpointC1 = SessionMpstTwo<Send<(), Offer1fromStoC>, RoleS<RoleEnd>, NameC>;
// S
type Choose1fromStoC = Send<Branching1fromStoC, End>;
type EndpointS1 = SessionMpstTwo<Recv<(), Choose1fromStoC>, RoleC<RoleBroadcast>, NameS>;

// Step 2
// C
type Choose2fromCtoS = Send<Branching2fromCtoS, End>;
type EndpointC2 = SessionMpstTwo<Recv<(), Choose2fromCtoS>, RoleS<RoleBroadcast>, NameC>;
// S
enum Branching2fromCtoS {
    Continue(SessionMpstTwo<Recv<(), Send<(), Offer3fromCtoS>>, RoleC<RoleC<RoleC<RoleEnd>>, NameS>),
    Quit(SessionMpstTwo<Recv<(), End>, RoleC<RoleEnd>, NameS>),
}
type Offer2fromCtoS = <Choose2fromCtoS as Session>::Dual;
type EndpointS2 = SessionMpstTwo<Send<(), Offer2fromCtoS>, RoleC<RoleC<RoleEnd>>, NameS>;

// Step 3
// C
type Choose3fromCtoS = Send<Branching3fromCtoS, End>;
type EndpointC3 = SessionMpstTwo<Send<(), Recv<(), Choose3fromCtoS>>, RoleS<RoleS<RoleBroadcast>>, NameC>;
// S
...
type EndpointS3 = SessionMpstTwo<Recv<(), Send<(), Offer3fromCtoS>>, RoleC<RoleC<RoleC<RoleEnd>>>, NameS>;
...
type EndpointC4 = SessionMpstTwo<Send<(), Offer4fromStoC>, RoleS<RoleS<RoleEnd>>, NameC>;
// S
type Choose4fromStoC = Send<Branching4fromStoC, End>;
type EndpointS4 = SessionMpstTwo<Recv<(), Choose4fromStoC>, RoleC<RoleBroadcast>, NameS>;

// Step 5
// C
type Choose5fromCtoS = Send<Branching5fromCtoS, End>;
type EndpointC5 = SessionMpstTwo<Recv<(), Choose5fromCtoS>, RoleS<RoleBroadcast>, NameC>;
// S
