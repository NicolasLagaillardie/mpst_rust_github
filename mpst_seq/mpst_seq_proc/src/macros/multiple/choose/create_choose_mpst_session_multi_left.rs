...
#[derive(Debug)]
pub struct ChooseTypeMultiLeftMacroInput {
    func_name: syn::Ident,
    type_name: syn::Ident,
    role_dual: syn::Ident,
    name: syn::Ident,
...
impl Parse for ChooseTypeMultiLeftMacroInput {
    fn parse(input: ParseStream) -> Result<Self> {
        ...
        Ok(ChooseTypeMultiLeftMacroInput {
            func_name,
            type_name,
            role_dual,
            name,
...
impl From<ChooseTypeMultiLeftMacroInput> for proc_macro2::TokenStream {
    fn from(input: ChooseTypeMultiLeftMacroInput) -> proc_macro2::TokenStream {
        input.expand()
    }
}

impl ChooseTypeMultiLeftMacroInput {
    ...
    fn expand(&self) -> proc_macro2::TokenStream {
        ...
        let new_sessions_left: Vec<proc_macro2::TokenStream> = (1..self.nsessions)
                .map(|i| {
