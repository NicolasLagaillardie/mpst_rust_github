...
#[derive(Debug)]
pub(crate) struct CheckingInputImpl {
...
impl Parse for CheckingInputImpl {
    fn parse(input: ParseStream) -> Result<Self> {
        ...
        Ok(CheckingInputImpl { choices })
    }
}

impl From<CheckingInputImpl> for TokenStream {
    fn from(input: CheckingInputImpl) -> TokenStream {
        input.expand()
    }
}

impl CheckingInputImpl {
