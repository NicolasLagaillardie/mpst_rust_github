...
pub type OfferMpst<S0, S1, S2, S3, R0, R1, N0, N1> =
    Recv<Either<SessionMpst<S0, S1, R0, N0>, SessionMpst<S2, S3, R1, N1>>, End>;
...
pub type ChooseMpst<S0, S1, S2, S3, R0, R1, N0, N1> = Send<
    Either<
        <SessionMpst<S0, S1, R0, N0> as Session>::Dual,
        <SessionMpst<S2, S3, R1, N1> as Session>::Dual,
    >,
    End,
>;
