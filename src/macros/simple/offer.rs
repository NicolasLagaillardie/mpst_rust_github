...
///  Create an *offer* function to recv on the first binary session from any kind of role.
...
///  Create an *offer* function to recv on the second binary session from any kind of role.
///  Must be used with [`mpstthree::sessionmpst::SessionMpst`].
///
///  # Arguments
///  
