...
///  Create a *recv* function to recv on the first binary session from any kind of role.
...
///  Create a *recv* function to recv on the second binary session from any kind of role.
///  Must be used with [`mpstthree::sessionmpst::SessionMpst`].
///
///  # Arguments
///  
...
///  Create a *recv* function to recv from a broadcasting role on the first binary session from any kind of role.
///  Must be used with [`mpstthree::sessionmpst::SessionMpst`].
///
///  # Arguments
///  
...
///  use mpstthree::role::Role;
///  use mpstthree::sessionmpst::SessionMpst;
///  use mpstthree::{create_normal_role, create_broadcast_role, create_recv_mpst_all_session_1};
///
///  create_normal_role!(RoleA, next_a, RoleADual, next_a_dual);
///  create_normal_role!(RoleC, next_c, RoleCDual, next_c_dual);
...
///  Create a *recv* function to recv from a broadcasting role on the second binary session from any kind of role.
///  Must be used with [`mpstthree::sessionmpst::SessionMpst`].
///
///  # Arguments
///  
...
///  use mpstthree::role::Role;
///  use mpstthree::sessionmpst::SessionMpst;
///  use mpstthree::{create_normal_role, create_broadcast_role, create_recv_mpst_all_session_2};
///
///  create_normal_role!(RoleA, next_a, RoleADual, next_a_dual);
///  create_normal_role!(RoleC, next_c, RoleCDual, next_c_dual);
