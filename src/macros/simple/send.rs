...
///  Create a *send* function to send on the first binary session from any kind of role.
...
///  Create a *send* function to send on the second binary session from any kind of role.
///  Must be used with [`mpstthree::sessionmpst::SessionMpst`].
///
///  # Arguments
///  
