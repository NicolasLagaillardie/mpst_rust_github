...
/// Shorter way to call the code within the send function
...
/// Creates a *send* function to send from a given binary
/// session type of a SessionMpst with more than 3
/// participants.
///
///  # Arguments
///  
...
/// Creates a *send* function to send from a given binary
/// session type of a SessionMpst with more than 3
/// participants. The send function will try to
/// send and panic if not possible (canceled session).
///
///  # Arguments
///  
///  * The name of the new *send* function
...
/// Creates a *send* function to send from a given binary
/// session type of a SessionMpst with more than 3
/// participants. Checks if the first binary session has a
/// "cancel" signal and panic if yes. The send function will
/// try to send and panic if not possible (canceled
/// session).
///
///  # Arguments
///  
...
/// Creates multiple *send* functions to send from a given
/// binary session type of a SessionMpst with more than 3
/// participants.
///
///  # Arguments
///  
