...
macro_rules! close_mpst {
    ($func_name:ident, $meshedchannels_name:ident, $nsessions:literal) => {
        mpst_seq_baking::close_mpst!($func_name, $meshedchannels_name, $nsessions);
    };
}
...
macro_rules! close_mpst_check_cancel {
    ($func_name:ident, $meshedchannels_name:ident, $nsessions:literal) => {
        mpst_seq_baking::close_mpst_check_cancel!($func_name, $meshedchannels_name, $nsessions);
    };
}
...
macro_rules! close_mpst_cancel {
    ($func_name:ident, $meshedchannels_name:ident, $nsessions:literal) => {
        mpst_seq_baking::close_mpst_cancel!($func_name, $meshedchannels_name, $nsessions);
    };
}
