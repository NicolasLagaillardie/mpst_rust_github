...
macro_rules! create_choose_type_multi {
    ($type_name:ident, $meshedchannels_name:ident, $nsessions:literal) => {
        mpst_seq_macros_multiple::create_choose_type_multi!(
            $type_name,
            $meshedchannels_name,
            $nsessions
        );
...
macro_rules! create_choose_mpst_session_multi_left {
    (
        ...
        mpst_seq_macros_multiple::create_choose_mpst_session_multi_left!(
            $func_name,
            $type_name,
            $role_dual,
            $name,
...
macro_rules! create_choose_mpst_session_multi_right {
    (
        ...
        mpst_seq_macros_multiple::create_choose_mpst_session_multi_right!(
            $func_name,
            $type_name,
            $role_dual,
            $name,
...
macro_rules! choose_mpst_multi_to_all {
    (
        ...
        mpst_seq_macros_multiple::choose_mpst_multi_to_all!(
            $session ,
            ( $( $label , )+ ) ,
            ( $( $receiver , )+ ) ,
            $sender ,
...
macro_rules! choose_mpst_create_multi_to_all {
    (
        ...
        mpst_seq_macros_multiple::choose_mpst_create_multi_to_all!(
            $name ,
            ( $( $receiver , )+ ) ,
            $sender ,
            $meshedchannels_name ,
...
macro_rules! choose_mpst_multi_cancel_to_all {
    (
        ...
        mpst_seq_macros_multiple::choose_mpst_multi_cancel_to_all!(
            $session ,
            ( $( $label , )+ ) ,
            ( $( $receiver , )+ ) ,
            $broadcaster ,
...
macro_rules! choose_mpst_multi_http_to_all {
    (
        ...
        mpst_seq_macros_multiple::choose_mpst_multi_http_to_all!(
            $session ,
            ( $( $label , )+ ) ,
            ( $( $receiver , )+ ) ,
            $sender ,
...
macro_rules! create_fn_choose_mpst_multi_to_all_bundle {
    (
        ...
        mpst_seq_macros_multiple::create_fn_choose_mpst_multi_to_all_bundle!(
            ( $( $fn_name , )+ ) ,
            ( $( $branch , )+ ) ,
            ( $( $label , )+ ) ,
            ( $( $receiver , )+ ) ,
...
macro_rules! create_fn_choose_mpst_cancel_multi_to_all_bundle {
    (
        ...
        mpst_seq_macros_multiple::create_fn_choose_mpst_cancel_multi_to_all_bundle!(
            ( $( $fn_name , )+ ) ,
            ( $( $branch , )+ ) ,
            ( $( $label , )+ ) ,
            ( $( $receiver , )+ ) ,
