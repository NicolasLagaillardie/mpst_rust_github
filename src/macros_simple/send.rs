...
macro_rules! create_send_mpst_session_1 {
    ($func_name:ident, $receiver:ident, $sender:ident) => {
        mpst_seq_baking::create_send_mpst_session!($func_name, $receiver, $sender, MeshedChannels, 3, 1);
    };
}
...
macro_rules! create_send_mpst_session_2 {
    ($func_name:ident, $receiver:ident, $sender:ident) => {
        mpst_seq_baking::create_send_mpst_session!($func_name, $receiver, $sender, MeshedChannels, 3, 2);
    };
}
