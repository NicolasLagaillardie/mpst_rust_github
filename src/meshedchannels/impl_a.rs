...
impl<S1: Session, S2: Session, R: Role, T: marker::Send>
    MeshedChannels<S1, Send<T, S2>, RoleC<R>, NameA>
{
...
impl<S1: Session, S2: Session, R: Role, T: marker::Send>
    MeshedChannels<Recv<T, S1>, S2, RoleB<R>, NameA>
{
...
impl<S1: Session, S2: Session, R: Role, T: marker::Send>
    MeshedChannels<S1, Recv<T, S2>, RoleC<R>, NameA>
{
...
impl<S1: Session, S2: Session, T: marker::Send>
    MeshedChannels<Recv<T, S1>, S2, RoleAlltoB<RoleEnd, RoleEnd>, NameA>
{
    #[doc(hidden)]
...
impl<S1: Session, S2: Session, T: marker::Send>
    MeshedChannels<S1, Recv<T, S2>, RoleAlltoC<RoleEnd, RoleEnd>, NameA>
{
    #[doc(hidden)]
    pub fn recv_from_all(self) -> ResultType<T, S1, S2, RoleEnd> {
...
impl<
    ...
    MeshedChannels<
        Send<
            Either<
                MeshedChannels<S2, <S0 as Session>::Dual, R0, NameB>,
                MeshedChannels<S4, <S1 as Session>::Dual, R1, NameB>,
            >,
            End,
        >,
        Send<Either<MeshedChannels<S3, S0, R2, NameC>, MeshedChannels<S5, S1, R3, NameC>>, End>,
        RoleAtoAll<R4, R5>,
        NameA,
    >
{
