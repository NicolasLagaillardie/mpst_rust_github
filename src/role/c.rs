...
/// Gives the order to the [`mpstthree::sessionmpst::SessionMpst`] related to C.
///
/// This `struct` should only be used in the `stack` field of the [`mpstthree::sessionmpst::SessionMpst`] related to C.
///
