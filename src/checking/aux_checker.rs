...
/// ]
#[doc(hidden)]
pub(crate) fn clean_session(session: String) -> Result<VecOfStr, Box<dyn Error>> {
...
/// ]
#[doc(hidden)]
pub(crate) fn get_blocks(full_block: String) -> Result<VecOfStr, Box<dyn Error>> {
