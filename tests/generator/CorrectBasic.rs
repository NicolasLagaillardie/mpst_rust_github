...
type Message_0_v_3_FromBToA =
    RecvTimed<Test5, 'a', 0, false, 2, false, ' ', Message_0_v_4_FromBToA>;
...
type Message_0_v_3_FromAToB =
    SendTimed<Test5, 'a', 0, false, 2, false, ' ', Message_0_v_4_FromAToB>;
...
fn endpoint_a_0_v_0(
    ...
    let s = s.send(Test2 { payload: Integer }, all_clocks)?;
    let s = s.send(Test3 { payload: Stri }, all_clocks)?;
