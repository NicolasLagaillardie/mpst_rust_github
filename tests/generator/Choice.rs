...
type Message_0_1_v_4_FromAToB =
    SendTimed<Test5, 'a', 0, true, 1, true, ' ', Message_0_1_v_5_FromAToB>;
type Message_0_1_v_5_FromAToB =
    SendTimed<Test6, 'a', 0, true, 1, true, ' ', Message_0_1_v_6_FromAToB>;
type Message_0_1_v_6_FromAToB =
    SendTimed<Test7, 'a', 0, true, 1, true, 'a', Message_0_1_v_7_FromAToB>;
type Message_0_1_v_7_FromAToB =
    SendTimed<Test8, 'a', 0, true, 1, true, 'a', Message_0_1_v_8_FromAToB>;
...
type Message_0_1_v_4_FromBToA =
    RecvTimed<Test5, 'a', 0, true, 1, true, ' ', Message_0_1_v_5_FromBToA>;
type Message_0_1_v_5_FromBToA =
    RecvTimed<Test6, 'a', 0, true, 1, true, ' ', Message_0_1_v_6_FromBToA>;
type Message_0_1_v_6_FromBToA =
    RecvTimed<Test7, 'a', 0, true, 1, true, 'a', Message_0_1_v_7_FromBToA>;
type Message_0_1_v_7_FromBToA =
    RecvTimed<Test8, 'a', 0, true, 1, true, 'a', Message_0_1_v_8_FromBToA>;
type Message_0_1_v_8_FromBToA = End;
type Message_0_0_v_1_FromBToC = End;

// Binary sessions for C
type Message_0_0_v_1_FromCToA = End;
type Message_0_0_v_1_FromCToB = End;

// Stacks for B
type Ordering_0_v_0_ForB = RoleA<RoleEnd>;
type Ordering_0_0_v_1_ForB = RoleEnd;
...
enum Choice_0_0_FromAToB {
    Branching_0(Endpoint_0_0_v_0_ForB),
    Branching_1(Endpoint_0_0_v_1_ForB),
}

// Enums (Branching) for C
enum Choice_0_0_FromAToC {
    Branching_0(Endpoint_0_0_v_0_ForC),
    Branching_1(Endpoint_0_0_v_1_ForC),
}
...
type Endpoint_0_0_v_0_ForA = MeshedChannels<
    Message_0_0_v_1_FromAToB,
    Message_0_0_v_1_FromAToC,
    Ordering_0_0_v_1_ForA,
    NameA,
>;

// Endpoint for role B
type Endpoint_0_0_v_0_ForB = MeshedChannels<
    Message_0_0_v_1_FromBToA,
    Message_0_0_v_1_FromBToC,
    Ordering_0_0_v_1_ForB,
    NameB,
>;

// Endpoint for role C
type Endpoint_0_0_v_0_ForC = MeshedChannels<
    Message_0_0_v_1_FromCToA,
    Message_0_0_v_1_FromCToB,
    Ordering_0_0_v_1_ForC,
    NameC,
>;
