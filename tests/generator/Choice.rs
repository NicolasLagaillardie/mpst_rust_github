...
// Binary sessions for C
type Message_0_1_v_0_FromCToA = RecvTimed<Choice_0_2_FromAToC, ' ', -2, false, -1, false, ' ', End>;
...
type Message_0_1_v_0_FromAToC = SendTimed<Choice_0_2_FromAToC, ' ', -2, false, -1, false, ' ', End>;
...
// Stacks for C
type Ordering_0_1_v_0_ForC = RoleA<RoleEnd>;
...
enum Choice_0_0_FromAToB {
	...
	Branching1(Endpoint_0_0_v_1_ForB),
	Branching2(Endpoint_0_0_v_2_ForB),
}

// Enums (Branching) for C
enum Choice_0_0_FromAToC {
	Branching0(Endpoint_0_0_v_0_ForC),
	Branching1(Endpoint_0_0_v_1_ForC),
	Branching2(Endpoint_0_0_v_2_ForC),
}
...
// Endpoint for role A
type Endpoint_0_2_v_0_ForA = MeshedChannels<Message_0_2_v_0_FromAToB, Message_0_2_v_0_FromAToC, Ordering_0_2_v_0_ForA, NameA>;

// Endpoint for role B
type Endpoint_0_2_v_0_ForB = MeshedChannels<Message_0_2_v_0_FromBToA, Message_0_2_v_0_FromBToC, Ordering_0_2_v_0_ForB, NameB>;

// Endpoint for role C
type Endpoint_0_2_v_0_ForC = MeshedChannels<Message_0_2_v_0_FromCToA, Message_0_2_v_0_FromCToB, Ordering_0_2_v_0_ForC, NameC>;
...
fn endpoint_a_0_2_v_0(s: Endpoint_0_2_v_0_ForA, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {
	all_clocks.insert('a', Instant::now());

	Ok(())
}

fn endpoint_a_0_2_v_1(s: Endpoint_0_2_v_0_ForA, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {
	all_clocks.insert('a', Instant::now());

	Ok(())
}

fn endpoint_a_0_2_v_2(s: Endpoint_0_2_v_0_ForA, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {
	all_clocks.insert('a', Instant::now());

	Ok(())
}

fn endpoint_b_0_2_v_0(s: Endpoint_0_2_v_0_ForB, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {
	all_clocks.insert('a', Instant::now());

	Ok(())
}

fn endpoint_b_0_2_v_1(s: Endpoint_0_2_v_0_ForB, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {
	all_clocks.insert('a', Instant::now());

	Ok(())
}

fn endpoint_b_0_2_v_2(s: Endpoint_0_2_v_0_ForB, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {
	all_clocks.insert('a', Instant::now());

	Ok(())
}

fn endpoint_c_0_2_v_0(s: Endpoint_0_2_v_0_ForC, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {

	Ok(())
}

fn endpoint_c_0_2_v_1(s: Endpoint_0_2_v_0_ForC, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {

	Ok(())
}

fn endpoint_c_0_2_v_2(s: Endpoint_0_2_v_0_ForC, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {

	Ok(())
}

fn endpoint_a_0_1_v_0(s: Endpoint_0_1_v_0_ForA, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {
	all_clocks.insert('a', Instant::now());

	Ok(())
}

fn endpoint_a_0_1_v_1(s: Endpoint_0_1_v_0_ForA, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {
	all_clocks.insert('a', Instant::now());

	Ok(())
}

fn endpoint_b_0_1_v_0(s: Endpoint_0_1_v_0_ForB, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {
	all_clocks.insert('a', Instant::now());

	Ok(())
}

fn endpoint_b_0_1_v_1(s: Endpoint_0_1_v_0_ForB, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {
	all_clocks.insert('a', Instant::now());

	Ok(())
}

fn endpoint_c_0_1_v_0(s: Endpoint_0_1_v_0_ForC, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {

	Ok(())
}

fn endpoint_c_0_1_v_1(s: Endpoint_0_1_v_0_ForC, all_clocks: &mut HashMap<char, Instant>) -> Result<(), Box<dyn Error>> {
