...
use mpstthree::{
    bundle_struct_fork_close_multi_interleaved, create_fn_choose_mpst_multi_to_all_bundle,
...
bundle_struct_fork_close_multi_interleaved!(close_mpst_multi, fork_mpst, MeshedChannelsThree, 3);
