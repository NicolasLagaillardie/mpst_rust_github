...
// For B
type EndpointBFull = MeshedChannels<End, RecursBtoC, StackBRecurs, NameB>;
...
#[test]
pub fn main_run_c_usecase_recursive() {
...
#[test]
pub fn main_run_c_usecase_recursive_checker() {
    ...
    println!("Graph A: {:?}", format!("{:?}", Dot::new(&graph_a)));
    ...
    println!("Graph B: {:?}", format!("{:?}", Dot::new(&graph_b)));
    ...
    println!("Graph C: {:?}", format!("{:?}", Dot::new(&graph_c)));
