...
pub fn send_both_positive_both_included_wrong_order_panics() {
    assert!(|| -> Result<(), Box<dyn Error>> {
        ...
        // Try to send
        let (sender, _receiver) = SendTimed::<i32, End, 'a', 2, true, 1, true, false>::new();
...
pub fn send_both_positive_both_included_reset_clock_receive_missing_panics() {
    assert!(|| -> Result<(), Box<dyn Error>> {
        ...
        // Try to send
        let (sender, receiver) = SendTimed::<i32, End, 'a', 1, true, 2, true, true>::new();
        cancel(receiver);
        let _ = send(x, &mut all_clocks, sender)?; // will fail
...
pub fn send_both_positive_both_included_wrong_reset_panics() {
    assert!(|| -> Result<(), Box<dyn Error>> {
        ...
        // Try to send
        let (sender, _receiver) = SendTimed::<i32, End, 'b', 1, true, 2, true, true>::new();
        let _ = send(x, &mut all_clocks, sender)?; // will fail
...
pub fn send_both_positive_upper_included_reset_clock_receive_missing_panics() {
    assert!(|| -> Result<(), Box<dyn Error>> {
        ...
        // Try to send
        let (sender, receiver) = SendTimed::<i32, End, 'a', 1, false, 2, true, true>::new();
        cancel(receiver);
        let _ = send(x, &mut all_clocks, sender)?; // will fail
...
pub fn send_both_positive_upper_included_receive_missing_panics() {
    assert!(|| -> Result<(), Box<dyn Error>> {
        ...
        // Try to send
        let (sender, receiver) = SendTimed::<i32, End, 'a', 1, false, 2, true, false>::new();
        cancel(receiver);
        let _ = send(x, &mut all_clocks, sender)?; // will fail
...
pub fn send_both_positive_upper_included_wrong_reset_panics() {
    assert!(|| -> Result<(), Box<dyn Error>> {
        ...
        // Try to send
        let (sender, _receiver) = SendTimed::<i32, End, 'b', 1, false, 2, true, true>::new();
        let _ = send(x, &mut all_clocks, sender)?; // will fail
...
pub fn send_both_positive_lower_included_lower_reset_clock_receive_missing_panics() {
    assert!(|| -> Result<(), Box<dyn Error>> {
        ...
        // Try to send
        let (sender, receiver) = SendTimed::<i32, End, 'a', 1, true, 2, false, true>::new();
        cancel(receiver);
        let _ = send(x, &mut all_clocks, sender)?; // will fail
...
pub fn send_both_positive_lower_included_lower_receive_missing_panics() {
    assert!(|| -> Result<(), Box<dyn Error>> {
        ...
        // Try to send
        let (sender, receiver) = SendTimed::<i32, End, 'a', 1, true, 2, false, false>::new();
        cancel(receiver);
        let _ = send(x, &mut all_clocks, sender)?; // will fail
...
pub fn send_both_positive_lower_included_wrong_reset_panics() {
    assert!(|| -> Result<(), Box<dyn Error>> {
        ...
        // Try to send
        let (sender, _receiver) = SendTimed::<i32, End, 'b', 1, true, 2, false, true>::new();
        let _ = send(x, &mut all_clocks, sender)?; // will fail
...
pub fn send_both_positive_none_included_reset_clock_receive_missing_panics() {
    assert!(|| -> Result<(), Box<dyn Error>> {
        ...
        // Try to send
        let (sender, receiver) = SendTimed::<i32, End, 'a', 1, false, 2, false, true>::new();
        cancel(receiver);
        let _ = send(x, &mut all_clocks, sender)?; // will fail
...
pub fn send_both_positive_none_included_receive_missing_panics() {
    assert!(|| -> Result<(), Box<dyn Error>> {
        ...
        // Try to send
        let (sender, receiver) = SendTimed::<i32, End, 'a', 1, false, 2, false, false>::new();
        cancel(receiver);
        let _ = send(x, &mut all_clocks, sender)?; // will fail
...
pub fn send_both_positive_none_included_wrong_reset_panics() {
    assert!(|| -> Result<(), Box<dyn Error>> {
        ...
        // Try to send
        let (sender, _receiver) = SendTimed::<i32, End, 'b', 1, false, 2, false, false>::new();
        let _ = send(x, &mut all_clocks, sender)?; // will fail
