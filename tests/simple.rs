...
/// Queueus
type QueueA = RoleASendToB<RoleAReceiveFromC<RoleEnd>>;
type QueueB = RoleBReceiveFromA<RoleBSendToC<RoleEnd>>;
type QueueC = RoleCSendToA<RoleCReceiveFromB<RoleEnd>>;
