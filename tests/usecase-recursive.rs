...
//     offer_mpst_b_to_c!(s, {
//         CBranchesBtoC::End(SessionMpst { session1: session_ba, session2: session_bc, queue: queue }) => {
//             let s = SessionMpst {
//                 session1: session_ba,
//                 session2: session_bc,
//                 queue: queue,
...
//             Ok(())
//         },
//         CBranchesBtoC::Video(SessionMpst { session1: session_ba, session2: session_bc, queue: queue}) => {
//             let s = SessionMpst {
//                 session1: session_ba,
//                 session2: session_bc,
//                 queue: queue,
...
//     offer_mpst_a_to_c!(s, {
//         CBranchesAtoC::End(SessionMpst { session1: session_ab, session2: session_ac, queue: queue}) => {
//             let s = SessionMpst {
//                 session1: session_ab,
//                 session2: session_ac,
//                 queue: queue,
...
//             Ok(())
//         },
//         CBranchesAtoC::Video(SessionMpst { session1: session_ab, session2: session_ac, queue: queue}) => {
//             let s = SessionMpst {
//                 session1: session_ab,
//                 session2: session_ac,
//                 queue: queue,
