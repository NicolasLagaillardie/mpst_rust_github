...
for i, val in enumerate(bar_build_ampst):
    print(bar_build_ampst[i]/bar_build_timed[i]*100)

print("")

for i, val in enumerate(bar_run_ampst):
    print(bar_run_ampst[i]/bar_run_timed[i]*100)
