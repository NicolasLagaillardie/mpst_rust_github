...
bench_files = ['Distributed calculator baking', 'Fibo MPST 20 baking', 'oAuth MPST baking', 'Online wallet baking',
               'Simple voting MPST baking', 'SMTP baking', 'Travel MPST baking', 'Three buyers MPST baking']

# Expected bench files
translate = {'Distributed calculator baking': 'distributed_calc', 'Fibo MPST 20 baking': 'fib', 'oAuth MPST baking': 'o_auth', 'Online wallet baking': 'online_wallet',
             'Simple voting MPST baking': 'simple_voting', 'SMTP baking': 'smtp', 'Travel MPST baking': 'three_travel', 'Three buyers MPST baking': 'three_buyers'}
