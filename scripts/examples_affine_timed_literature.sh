...
bash ./scripts/create_files/compile_normal.sh http 10 baking
...
bash ./scripts/create_files/compile_normal.sh servo_8257_fixed 10 baking_checking
...
bash ./scripts/create_files/compile_normal.sh sleeping_barber 10 interleaved
