...
python3 scripts/create_graphs/mesh_compile_average.py

# Create the graph from the compile-time of Ring
python3 scripts/create_graphs/ring_compile_average.py

# Create the graph from the compile-time of Ping-Pong
python3 scripts/create_graphs/ping_pong_compile_average.py
