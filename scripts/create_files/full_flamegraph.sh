...
cargo flamegraph --example travel_agency -o flamegraphs/flamegraph_travel_agency.svg
...
cargo flamegraph --example calculator -o flamegraphs/flamegraph_calculator.svg
