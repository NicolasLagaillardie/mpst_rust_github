...
cargo fmt --all
cargo clippy --workspace --all-features --all-targets --verbose --locked -- -D warnings
# cargo hack --feature-powerset --exclude-no-default-features clippy --locked -- -D warning
cargo test --all-targets --verbose --workspace --all-features  --locked
cargo clean
