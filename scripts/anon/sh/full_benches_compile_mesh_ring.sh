...
bash ./scripts/create_files/compile_normal.sh mesh_five_baking_atmp 1 baking_atmp

### Six
echo "Mesh six"
bash ./scripts/create_files/compile_normal.sh mesh_six_baking_ampst 1 baking
bash ./scripts/create_files/compile_normal.sh mesh_six_baking_atmp 1 baking_atmp

### Seven
echo "Mesh seven"
bash ./scripts/create_files/compile_normal.sh mesh_seven_baking_ampst 1 baking
bash ./scripts/create_files/compile_normal.sh mesh_seven_baking_atmp 1 baking_atmp

### Eight
echo "Mesh eight"
bash ./scripts/create_files/compile_normal.sh mesh_eight_baking_ampst 1 baking
bash ./scripts/create_files/compile_normal.sh mesh_eight_baking_atmp 1 baking_atmp
...
bash ./scripts/create_files/compile_normal.sh ring_five_baking_atmp 1 baking_atmp

### Six
echo "Ring six"
bash ./scripts/create_files/compile_normal.sh ring_six_baking_ampst 1 baking
bash ./scripts/create_files/compile_normal.sh ring_six_baking_atmp 1 baking_atmp

### Seven
echo "Ring seven"
bash ./scripts/create_files/compile_normal.sh ring_seven_baking_ampst 1 baking
bash ./scripts/create_files/compile_normal.sh ring_seven_baking_atmp 1 baking_atmp

### Eight
echo "Ring eight"
bash ./scripts/create_files/compile_normal.sh ring_eight_baking_ampst 1 baking
bash ./scripts/create_files/compile_normal.sh ring_eight_baking_atmp 1 baking_atmp
