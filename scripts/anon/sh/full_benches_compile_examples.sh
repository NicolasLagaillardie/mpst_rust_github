...
bash ./scripts/create_files/compile_normal.sh calculator_atmp 1 baking_atmp
bash ./scripts/create_files/compile_normal.sh online_wallet_atmp 1 baking_atmp
bash ./scripts/create_files/compile_normal.sh smtp_atmp 1 baking_atmp
bash ./scripts/create_files/compile_normal.sh simple_voting_atmp 1 baking_atmp
bash ./scripts/create_files/compile_normal.sh three_buyers_atmp 1 baking_atmp
bash ./scripts/create_files/compile_normal.sh travel_agency_atmp 1 baking_atmp
bash ./scripts/create_files/compile_normal.sh o_auth_atmp 1 baking_atmp
bash ./scripts/create_files/compile_normal.sh http_atmp 1 baking_atmp
bash ./scripts/create_files/compile_normal.sh remote_data_atmp 1 baking_atmp
bash ./scripts/create_files/compile_normal.sh servo_atmp 1 baking_atmp

## Compile rate-base examples, ATMP version
bash ./scripts/create_files/compile_normal.sh gravity_android_atmp 1 baking_atmp
bash ./scripts/create_files/compile_normal.sh pinetime_heart_rate_atmp 1 baking_atmp
bash ./scripts/create_files/compile_normal.sh proximity_based_car_key_atmp 1 baking_atmp
