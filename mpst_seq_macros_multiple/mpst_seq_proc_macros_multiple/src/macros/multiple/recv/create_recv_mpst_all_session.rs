...
#[derive(Debug)]
pub struct CreateRecvMPSTAllSession {
    func_name: syn::Ident,
    sender: syn::Ident,
    receiver: syn::Ident,
...
impl Parse for CreateRecvMPSTAllSession {
...
impl From<CreateRecvMPSTAllSession> for proc_macro2::TokenStream {
    fn from(input: CreateRecvMPSTAllSession) -> proc_macro2::TokenStream {
        input.expand()
    }
}

impl CreateRecvMPSTAllSession {
