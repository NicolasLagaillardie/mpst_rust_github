...
bundle_struct_fork_close_multi_cancel!(close_mpst_multi, fork_mpst, MeshedChannels, 11);
...
type EndpointDoneK =
    MeshedChannels<End, End, End, End, End, End, End, End, End, End, RoleEnd, NameK>;
...
type EndpointA =
    MeshedChannels<End, End, End, End, End, End, End, End, End, RecursAtoK, RoleK<RoleEnd>, NameA>;
type EndpointB =
    MeshedChannels<End, End, End, End, End, End, End, End, End, RecursBtoK, RoleK<RoleEnd>, NameB>;
type EndpointC =
    MeshedChannels<End, End, End, End, End, End, End, End, End, RecursCtoK, RoleK<RoleEnd>, NameC>;
type EndpointD =
    MeshedChannels<End, End, End, End, End, End, End, End, End, RecursDtoK, RoleK<RoleEnd>, NameD>;
type EndpointE =
    MeshedChannels<End, End, End, End, End, End, End, End, End, RecursEtoK, RoleK<RoleEnd>, NameE>;
type EndpointF =
    MeshedChannels<End, End, End, End, End, End, End, End, End, RecursFtoK, RoleK<RoleEnd>, NameF>;
type EndpointG =
    MeshedChannels<End, End, End, End, End, End, End, End, End, RecursGtoK, RoleK<RoleEnd>, NameG>;
type EndpointH =
    MeshedChannels<End, End, End, End, End, End, End, End, End, RecursHtoK, RoleK<RoleEnd>, NameH>;
type EndpointI =
    MeshedChannels<End, End, End, End, End, End, End, End, End, RecursItoK, RoleK<RoleEnd>, NameI>;
type EndpointJ =
    MeshedChannels<End, End, End, End, End, End, End, End, End, RecursJtoK, RoleK<RoleEnd>, NameJ>;
...
fn endpoint_g(s: EndpointG) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_g_from_k, {
        ...
        Branching0fromKtoG::Forward(s) => {
            ...
            let s = send_mpst_g_to_h((), s)?;            endpoint_g(s)
        },
        Branching0fromKtoG::Backward(s) => {
            let ((), s) = recv_mpst_g_from_h(s)?;
            let s = send_mpst_g_to_f((), s)?;            endpoint_g(s)
        },
    })
}
...
fn endpoint_h(s: EndpointH) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_h_from_k, {
        ...
        Branching0fromKtoH::Forward(s) => {
            ...
            let s = send_mpst_h_to_i((), s)?;            endpoint_h(s)
        },
        Branching0fromKtoH::Backward(s) => {
            let ((), s) = recv_mpst_h_from_i(s)?;
            let s = send_mpst_h_to_g((), s)?;            endpoint_h(s)
        },
    })
}
...
fn endpoint_i(s: EndpointI) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_i_from_k, {
        ...
        Branching0fromKtoI::Backward(s) => {
            ...
            let s = send_mpst_i_to_h((), s)?;            endpoint_i(s)
        },
    })
}
...
fn endpoint_j(s: EndpointJ) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_j_from_k, {
        ...
        Branching0fromKtoJ::Forward(s) => {
            ...
            let s = send_mpst_j_to_k((), s)?;            endpoint_j(s)
        },
        Branching0fromKtoJ::Backward(s) => {
            let ((), s) = recv_mpst_j_from_k(s)?;
            let s = send_mpst_j_to_i((), s)?;            endpoint_j(s)
        },
    })
}
...
pub fn ring_protocol_mpst(c: &mut Criterion) {
    c.bench_function(&format!("ring eleven cancel {LOOPS}"), |b| b.iter(aux));
}
