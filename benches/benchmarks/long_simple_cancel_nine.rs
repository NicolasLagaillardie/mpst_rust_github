...
fn simple_nine_endpoint_central(s: EndpointCentral) -> Result<(), Box<dyn Error>> {
    broadcast_cancel!(s, RoleCentral, 10);
    Ok(())
}

fn simple_nine_endpoint_a(s: EndpointA) -> Result<(), Box<dyn Error>> {
    offer_cancel_mpst!(s, recv_mpst_a_from_i, {
        ...
        Branching0fromItoA::More(s) => {
            ...
            simple_nine_endpoint_a(s)
        },
    })
}

fn simple_nine_endpoint_b(s: EndpointB) -> Result<(), Box<dyn Error>> {
    offer_cancel_mpst!(s, recv_mpst_b_from_i, {
        ...
        Branching0fromItoB::More(s) => {
            ...
            simple_nine_endpoint_b(s)
        },
    })
}

fn simple_nine_endpoint_c(s: EndpointC) -> Result<(), Box<dyn Error>> {
    offer_cancel_mpst!(s, recv_mpst_c_from_i, {
        ...
        Branching0fromItoC::More(s) => {
            ...
            simple_nine_endpoint_c(s)
        },
    })
}

fn simple_nine_endpoint_d(s: EndpointD) -> Result<(), Box<dyn Error>> {
    offer_cancel_mpst!(s, recv_mpst_d_from_i, {
        ...
        Branching0fromItoD::More(s) => {
            ...
            simple_nine_endpoint_d(s)
        },
    })
}

fn simple_nine_endpoint_e(s: EndpointE) -> Result<(), Box<dyn Error>> {
    offer_cancel_mpst!(s, recv_mpst_e_from_i, {
        ...
        Branching0fromItoE::More(s) => {
            ...
            simple_nine_endpoint_e(s)
        },
    })
}

fn simple_nine_endpoint_f(s: EndpointF) -> Result<(), Box<dyn Error>> {
    offer_cancel_mpst!(s, recv_mpst_f_from_i, {
        ...
        Branching0fromItoF::More(s) => {
            ...
            simple_nine_endpoint_f(s)
        },
    })
}

fn simple_nine_endpoint_g(s: EndpointG) -> Result<(), Box<dyn Error>> {
    offer_cancel_mpst!(s, recv_mpst_g_from_i, {
        ...
        Branching0fromItoG::More(s) => {
            ...
            simple_nine_endpoint_g(s)
        },
    })
}

fn simple_nine_endpoint_h(s: EndpointH) -> Result<(), Box<dyn Error>> {
    offer_cancel_mpst!(s, recv_mpst_h_from_i, {
        ...
        Branching0fromItoH::More(s) => {
            ...
            simple_nine_endpoint_h(s)
        },
    })
}

fn simple_nine_endpoint_i(s: EndpointI) -> Result<(), Box<dyn Error>> {
    recurs_i(s, SIZE)
}
...
fn all_mpst() -> Result<(), Box<dyn std::any::Any + std::marker::Send>> {
    let (
        ...
        black_box(simple_nine_endpoint_central),
        black_box(simple_nine_endpoint_a),
        black_box(simple_nine_endpoint_b),
        black_box(simple_nine_endpoint_c),
        black_box(simple_nine_endpoint_d),
        black_box(simple_nine_endpoint_e),
        black_box(simple_nine_endpoint_f),
        black_box(simple_nine_endpoint_g),
        black_box(simple_nine_endpoint_h),
        black_box(simple_nine_endpoint_i),
    );
