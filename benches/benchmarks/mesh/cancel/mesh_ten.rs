...
bundle_struct_fork_close_multi_cancel!(close_mpst_multi, fork_mpst, SessionMpstTen, 10);
...
fn endpoint_a(s: EndpointA) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_a_from_j, {
        ...
        Branching0fromJtoA::More(s) => {
            ...
            let s = send_mpst_a_to_j((), s)?;            let (_, s) = recv_mpst_a_from_b(s)?;
            ...
            let s = send_mpst_a_to_i((), s)?;            endpoint_a(s)
        },
    })
}
...
fn endpoint_b(s: EndpointB) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_b_from_j, {
        ...
        Branching0fromJtoB::More(s) => {
            ...
            let s = send_mpst_b_to_j((), s)?;            let s = send_mpst_b_to_a((), s)?;            let (_, s) = recv_mpst_b_from_a(s)?;
            ...
            let s = send_mpst_b_to_i((), s)?;            endpoint_b(s)
        },
    })
}
...
fn endpoint_c(s: EndpointC) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_c_from_j, {
        ...
        Branching0fromJtoC::More(s) => {
            ...
            let s = send_mpst_c_to_j((), s)?;            let s = send_mpst_c_to_a((), s)?;            let (_, s) = recv_mpst_c_from_a(s)?;
            ...
            let s = send_mpst_c_to_i((), s)?;            endpoint_c(s)
        },
    })
}
...
fn endpoint_d(s: EndpointD) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_d_from_j, {
        ...
        Branching0fromJtoD::More(s) => {
            ...
            let s = send_mpst_d_to_j((), s)?;            let s = send_mpst_d_to_a((), s)?;            let (_, s) = recv_mpst_d_from_a(s)?;
            ...
            let s = send_mpst_d_to_i((), s)?;            endpoint_d(s)
        },
    })
}
...
fn endpoint_e(s: EndpointE) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_e_from_j, {
        ...
        Branching0fromJtoE::More(s) => {
            ...
            let s = send_mpst_e_to_j((), s)?;            let s = send_mpst_e_to_a((), s)?;            let (_, s) = recv_mpst_e_from_a(s)?;
            ...
            let s = send_mpst_e_to_i((), s)?;            endpoint_e(s)
        },
    })
}
...
fn endpoint_f(s: EndpointF) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_f_from_j, {
        ...
        Branching0fromJtoF::More(s) => {
            ...
            let s = send_mpst_f_to_j((), s)?;            let s = send_mpst_f_to_a((), s)?;            let (_, s) = recv_mpst_f_from_a(s)?;
            ...
            let s = send_mpst_f_to_i((), s)?;            endpoint_f(s)
        },
    })
}
...
fn endpoint_g(s: EndpointG) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_g_from_j, {
        ...
        Branching0fromJtoG::More(s) => {
            ...
            let s = send_mpst_g_to_j((), s)?;            let s = send_mpst_g_to_a((), s)?;            let (_, s) = recv_mpst_g_from_a(s)?;
            ...
            let s = send_mpst_g_to_i((), s)?;            endpoint_g(s)
        },
    })
}
...
fn endpoint_h(s: EndpointH) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_h_from_j, {
        ...
        Branching0fromJtoH::More(s) => {
            ...
            let s = send_mpst_h_to_j((), s)?;            let s = send_mpst_h_to_a((), s)?;            let (_, s) = recv_mpst_h_from_a(s)?;
...
fn endpoint_i(s: EndpointI) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_i_from_j, {
        ...
        Branching0fromJtoI::More(s) => {
            ...
            let s = send_mpst_i_to_j((), s)?;            let s = send_mpst_i_to_a((), s)?;            let (_, s) = recv_mpst_i_from_a(s)?;
