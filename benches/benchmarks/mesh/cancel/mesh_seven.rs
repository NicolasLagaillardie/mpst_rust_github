...
bundle_struct_fork_close_multi_cancel!(close_mpst_multi, fork_mpst, SessionMpstSeven, 7);
...
fn endpoint_a(s: EndpointA) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_a_from_g, {
        ...
        Branching0fromGtoA::More(s) => {
            ...
            let s = send_mpst_a_to_g((), s)?;            let (_, s) = recv_mpst_a_from_b(s)?;
            ...
            let s = send_mpst_a_to_f((), s)?;            endpoint_a(s)
        },
    })
}
...
fn endpoint_b(s: EndpointB) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_b_from_g, {
        ...
        Branching0fromGtoB::More(s) => {
            ...
            let s = send_mpst_b_to_g((), s)?;            let s = send_mpst_b_to_a((), s)?;            let (_, s) = recv_mpst_b_from_a(s)?;
            ...
            let s = send_mpst_b_to_f((), s)?;            endpoint_b(s)
        },
    })
}
...
fn endpoint_c(s: EndpointC) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_c_from_g, {
        ...
        Branching0fromGtoC::More(s) => {
            ...
            let s = send_mpst_c_to_g((), s)?;            let s = send_mpst_c_to_a((), s)?;            let (_, s) = recv_mpst_c_from_a(s)?;
            ...
            let s = send_mpst_c_to_f((), s)?;            endpoint_c(s)
        },
    })
}
...
fn endpoint_d(s: EndpointD) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_d_from_g, {
        ...
        Branching0fromGtoD::More(s) => {
            ...
            let s = send_mpst_d_to_g((), s)?;            let s = send_mpst_d_to_a((), s)?;            let (_, s) = recv_mpst_d_from_a(s)?;
            ...
            let s = send_mpst_d_to_f((), s)?;            endpoint_d(s)
        },
    })
}
...
fn endpoint_e(s: EndpointE) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_e_from_g, {
        ...
        Branching0fromGtoE::More(s) => {
            ...
            let s = send_mpst_e_to_g((), s)?;            let s = send_mpst_e_to_a((), s)?;            let (_, s) = recv_mpst_e_from_a(s)?;
...
fn endpoint_f(s: EndpointF) -> Result<(), Box<dyn Error>> {
    offer_mpst!(s, recv_mpst_f_from_g, {
        ...
        Branching0fromGtoF::More(s) => {
            ...
            let s = send_mpst_f_to_g((), s)?;            let s = send_mpst_f_to_a((), s)?;            let (_, s) = recv_mpst_f_from_a(s)?;
...
fn mesh_protocol_binary(c: &mut Criterion) {
    c.bench_function(
        &format!("mesh seven cancel protocol binary {}", SIZE),
...
fn mesh_protocol_crossbeam(c: &mut Criterion) {
    c.bench_function(
        &format!("mesh seven cancel protocol crossbeam {}", SIZE),
