...
type EndpointB =
    MeshedChannelsHeight<End, End, End, End, End, End, RecursBtoG, RoleG<RoleEnd>, NameB>;
type EndpointC =
    MeshedChannelsHeight<End, End, End, End, End, End, RecursCtoG, RoleG<RoleEnd>, NameC>;
type EndpointD =
    MeshedChannelsHeight<End, End, End, End, End, End, RecursDtoG, RoleG<RoleEnd>, NameD>;
type EndpointE =
    MeshedChannelsHeight<End, End, End, End, End, End, RecursEtoG, RoleG<RoleEnd>, NameE>;
type EndpointF =
    MeshedChannelsHeight<End, End, End, End, End, End, RecursFtoG, RoleG<RoleEnd>, NameF>;
...
fn ring_protocol_mpst(c: &mut Criterion) {
    c.bench_function(
        &format!("ring seven cancel broadcast protocol MPST {}", LOOPS),
        |b| b.iter(|| all_mpst()),
    );
}
