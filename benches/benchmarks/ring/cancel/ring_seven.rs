...
type EndpointForwardG = SessionMpstSeven<
    Choose0fromGtoA,
    Choose0fromGtoB,
    Choose0fromGtoC,
    Choose0fromGtoD,
    ...
    NameG,
>;
type EndpointBackwardG = SessionMpstSeven<
    Choose0fromGtoA,
    Choose0fromGtoB,
    Choose0fromGtoC,
    Choose0fromGtoD,
...
fn ring_protocol_binary(c: &mut Criterion) {
    c.bench_function(
        &format!("ring seven cancel protocol binary {}", SIZE),
...
fn ring_protocol_crossbeam(c: &mut Criterion) {
    c.bench_function(
        &format!("ring seven cancel protocol crossbeam {}", SIZE),
