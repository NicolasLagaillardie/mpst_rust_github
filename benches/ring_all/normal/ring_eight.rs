...
pub fn ring_protocol_mpst(c: &mut Criterion) {
    c.bench_function(&format!("ring eight protocol MPST {}", LOOPS), |b| {
        b.iter(all_mpst)
    });
}

pub fn ring_protocol_binary(c: &mut Criterion) {
    c.bench_function(&format!("ring eight protocol binary {}", LOOPS), |b| {
        b.iter(all_binaries)
    });
}

pub fn ring_protocol_crossbeam(c: &mut Criterion) {
    c.bench_function(&format!("ring eight protocol crossbeam {}", LOOPS), |b| {
