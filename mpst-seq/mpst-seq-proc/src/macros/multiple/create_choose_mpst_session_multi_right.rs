...
#[derive(Debug)]
pub struct ChooseTypeMultiRightMacroInput {
    func_name: syn::Ident,
    type_name: syn::Ident,
    role_dual: syn::Ident,
    name: syn::Ident,
...
impl Parse for ChooseTypeMultiRightMacroInput {
    fn parse(input: ParseStream) -> Result<Self> {
        ...
        Ok(ChooseTypeMultiRightMacroInput {
            func_name,
            type_name,
            role_dual,
            name,
...
impl From<ChooseTypeMultiRightMacroInput> for proc_macro2::TokenStream {
    fn from(input: ChooseTypeMultiRightMacroInput) -> proc_macro2::TokenStream {
        input.expand()
    }
}

impl ChooseTypeMultiRightMacroInput {
