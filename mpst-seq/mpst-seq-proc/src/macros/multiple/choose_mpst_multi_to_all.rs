...
#[derive(Debug)]
pub struct ChooseTypeMultiToAllMacroInput {
...
impl Parse for ChooseTypeMultiToAllMacroInput {
    fn parse(input: ParseStream) -> Result<Self> {
        ...
        Ok(ChooseTypeMultiToAllMacroInput {
...
impl From<ChooseTypeMultiToAllMacroInput> for proc_macro2::TokenStream {
    fn from(input: ChooseTypeMultiToAllMacroInput) -> proc_macro2::TokenStream {
        input.expand()
    }
}

impl ChooseTypeMultiToAllMacroInput {
