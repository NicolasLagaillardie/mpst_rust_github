...
#[derive(Debug)]
pub struct CloseMpstCancelMacroInput {
    func_name: syn::Ident,
    sessionmpst_name: syn::Ident,
    nsessions: u64,
}

impl Parse for CloseMpstCancelMacroInput {
...
impl From<CloseMpstCancelMacroInput> for proc_macro2::TokenStream {
    fn from(input: CloseMpstCancelMacroInput) -> proc_macro2::TokenStream {
        input.expand()
    }
}

impl CloseMpstCancelMacroInput {
