...
#[derive(Debug)]
pub struct ChooseTypeMultiToAllBundleMacroInput {
...
impl Parse for ChooseTypeMultiToAllBundleMacroInput {
    fn parse(input: ParseStream) -> Result<Self> {
        ...
        Ok(ChooseTypeMultiToAllBundleMacroInput {
            labels: all_labels,
...
impl From<ChooseTypeMultiToAllBundleMacroInput> for proc_macro2::TokenStream {
    fn from(input: ChooseTypeMultiToAllBundleMacroInput) -> proc_macro2::TokenStream {
        input.expand()
    }
}

impl ChooseTypeMultiToAllBundleMacroInput {
